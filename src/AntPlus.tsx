...
const {AntPlus} = NativeModules
export const AntPlusEmitter = new NativeEventEmitter(AntPlus)

interface AntPlusInterface {
  startScan(devices: number[], scanSearch: number): Promise<string>
...
export default AntPlus as AntPlusInterface
